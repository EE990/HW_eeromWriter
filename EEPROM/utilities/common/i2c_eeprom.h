...
/** @defgroup I2C_EEPROM_Exported_Constants I2C EEPROM exported constants
  * @{
  */
#define I2C_EEPROM_SPEED         (20000)//(400000)                                       /*!< I2C speed              */
#define I2C_EEPROM_CAPACITY      2048//(32768)//(16384)//(256)                                        /*!< capacity in bytes      */
#define I2C_EEPROM_PAGE_SIZE     (1024)//(32)//(8)                                            /*!< page size in bytes     */
...
#define I2C_EEPROM_DEV_ADDR      (0x51)//(0x51)                                         /*!< I2C device address     */

#define I2C_EEPROM_PAGE_ADDR_IS_15BIT 1
#define I2C_EEPROM_READ_ONLY 1
/**
  * @}
  */
...
#if I2C_EEPROM_PAGE_ADDR_IS_15BIT
