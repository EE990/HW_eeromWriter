...
/** @addtogroup HT32F520xx
  * @{
  */


#ifndef __HT32F520XX_01_H__
#define __HT32F520XX_01_H__

#ifdef __cplusplus
 extern "C" {
#endif

#if !defined(USE_HT32F52220_30) && !defined(USE_HT32F52231_41) && !defined(USE_HT32F52331_41) && !defined(USE_HT32F52342_52)
...
/**
 * @brief Value of the Internal Low Speed oscillator in Hz
  */
#define LSI_VALUE         32000UL     /*!< Value of the Internal Low Speed oscillator in Hz                 */

#if !defined(USE_HT32F52220_30)
/**
 * @brief Value of the External Low Speed oscillator in Hz
  */
...
#include "system_ht32f520xx_01.h"      /* HT32 system                                                       */
...
typedef struct
{
  ...
  __IO uint32_t PSCR;            /*!< 0x084          Prescaler Register                                     */
  __IO uint32_t CRR;             /*!< 0x088          Counter Reload Register                                */
       uint32_t RESERVED5[1];    /*!< 0x090          Reserved                                               */
