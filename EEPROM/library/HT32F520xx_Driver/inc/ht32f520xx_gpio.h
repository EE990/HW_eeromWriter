...
#ifndef __HT32F520XX_GPIO_H
#define __HT32F520XX_GPIO_H
...
#if defined(LIBCFG_SCI0) || defined(LIBCFG_SCI1)
#define AFIO_FUN_SCI        AFIO_MODE_8        /*!< AFIO mode SMC                                           */
#endif
#if defined(LIBCFG_EBI)
...
#define IS_GPIO(x)          (IS_GPIO1(x) || IS_GPIO2(x) || IS_GPIO3(x))
...
#define IS_AFIO_ESS(x)      (IS_AFIO_ESS1(x) || IS_AFIO_ESS2(x) || IS_AFIO_ESS3(x))
